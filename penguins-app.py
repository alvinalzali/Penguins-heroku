...
if uploaded_file is not None:
    ...
    def user_input_features():
        island = st.sidebar.selectbox('Island', ('Biscoe', 'Dream', 'Torgiran'))
...
penguins_row = pd.read_csv('penguins_cleaned.csv')
penguins = penguins_row.drop(columns=['species'])
...
for col in encode:
    ...
    del df[col]
df = df[:1] #select the first row only

#displat the user input features
...
#apply the model to the user input features
